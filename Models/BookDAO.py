class BookDAO():
    ...
    def reserve(self,user_id,book_id):
        if not self.availaible(book_id):
            return "error_out"
    ...
    def getBookByUser(self,user_id):
    ...
    def getBookcountByUser(self,user_id):
    ...
    def search_book(self,name,availability=1) :
        query = " select * from @table where name LIKE '%{}%'".format(availability)
